...
For a complete example of using Archmage with Unity, see the [Unity demo project](https://github.com/shadowopera/sdk-cs/blob/main/unity/ArchmageDev/Assets/Scripts/ConfLoader.cs). It demonstrates multiple loading approaches including Addressables, Resources, and StreamingAssets filesystems, with support for both synchronous and asynchronous loading strategies, custom logging, and concurrent load optimization.
