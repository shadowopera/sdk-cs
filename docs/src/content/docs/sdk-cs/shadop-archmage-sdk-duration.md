...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/system.valuetype) → [Duration](../shadop-archmage-sdk-duration/)<br>
...
`m` [Duration](../shadop-archmage-sdk-duration/)<br>
...
`other` [Duration](../shadop-archmage-sdk-duration/)<br>
