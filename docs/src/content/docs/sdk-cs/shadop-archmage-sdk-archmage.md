...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Archmage](../shadop-archmage-sdk-archmage/)<br>
...
`atlas` [IAtlas](../shadop-archmage-sdk-iatlas/)<br>
...
`duration` [Duration](../shadop-archmage-sdk-duration/)<br>
