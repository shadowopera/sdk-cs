...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → JsonConverter → [Vec4JsonConverter](../shadop-archmage-sdk-vec4jsonconverter/)<br>
