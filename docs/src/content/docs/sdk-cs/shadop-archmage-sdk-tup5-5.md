...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Tup5<T0, T1, T2, T3, T4>](../shadop-archmage-sdk-tup5-5/)<br>
...
`other` [Tup5<T0, T1, T2, T3, T4>](../shadop-archmage-sdk-tup5-5/)<br>
