...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → JsonConverter → [Vec3JsonConverter](../shadop-archmage-sdk-vec3jsonconverter/)<br>
