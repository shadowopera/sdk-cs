...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Tup3<T0, T1, T2>](./shadop.archmage.tup3-3.md)<br>
...
`other` [Tup3<T0, T1, T2>](./shadop.archmage.tup3-3.md)<br>
