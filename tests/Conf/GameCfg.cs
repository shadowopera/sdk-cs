...
namespace Conf
{
    public partial class GameCfg
    {
        ...
        [JsonProperty("x-vector2")] public Vec2<int> XVector2 { get; set; }
        /// <summary>desc-x-vector3</summary>
        [JsonProperty("x-vector3")] public Vec3<float> XVector3 { get; set; }
        /// <summary>desc-x-vector4</summary>
        [JsonProperty("x-vector4")] public Vec4<float> XVector4 { get; set; }
